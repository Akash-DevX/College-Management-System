...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const validMenu = MENU_ITEMS.find(
      (item) => item.id === pathMenuId
    );
  ...
  const currentMenu =
    MENU_ITEMS.find((item) => item.id === selectedMenu) ||
    MENU_ITEMS[0];
                ...
                <div className="p-4 mt-2">
                  <div className="rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 p-4">
                    ...
                    <p className="text-[11px] leading-4 text-blue-700">
                      Manage your timetable, study materials, students,
                      marks, exams and college notices.
                    </p>
