          ...
          <Section icon={FiUser} title="Personal Information">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <InfoItem
                ...
                label="Salary"
                value={
                  profileData.salary !== undefined &&
                  profileData.salary !== null
                    ? `₹${Number(profileData.salary).toLocaleString("en-IN")}`
                    : "Not available"
                }
              />
        ...
        <div>
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 rounded-2xl p-5 h-full">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between p-3 rounded-xl bg-white border border-blue-100">
